...
-- default: 100
local axisx = tonumber(minetest.setting_get("thelowerroad.axisx")) or 0
...
local elevation_offset = tonumber(minetest.setting_get("thelowerroad.roadelevation")) or 0

-- the material the road is build of
--- main material
local t1rb1 = { name = "nc_concrete:terrain_stone_bricky", force_place = true, prob = 255 }
local t2rb1 = { name = "nc_concrete:concrete_adobe_bricky", force_place = true, prob = 255 }
local t3rb1 = { name = "nc_concrete:concrete_sandstone_bricky", force_place = true, prob = 255 }
local t4rb1 = { name = "nc_concrete:concrete_coalstone_bricky", force_place = true, prob = 255 }
--- border
local t1rb2 = { name = "nc_stonework:bricks_bonded", force_place = true, prob = 255 }
local t2rb2 = { name = "nc_stonework:bricks_adobe_bonded", force_place = true, prob = 255 }
local t3rb2 = { name = "nc_stonework:bricks_sandstone_bonded", force_place = true, prob = 255 }
local t4rb2 = { name = "nc_stonework:bricks_coalstone_bonded", force_place = true, prob = 255 }
--- road decoration
local t1rb3 = { name = "nc_terrain:gravel", force_place = true, prob = 6 }
local t2rb3 = { name = "nc_terrain:dirt", force_place = true, prob = 6 }
local t3rb3 = { name = "nc_terrain:sand", force_place = true, prob = 6 }
local t4rb3 = { name = "nc_terrain:gravel", force_place = true, prob = 6 }
--- stairs
local t1nst = { name = "air", param2 = 2, force_place = true, prob = 255 }
local t1pst = { name = "air", force_place = true, prob = 255 }
local t2nst = { name = "air", param2 = 2, force_place = true, prob = 255 }
local t2pst = { name = "air", force_place = true, prob = 255 }
local t3nst = { name = "air", param2 = 2, force_place = true, prob = 255 }
local t3pst = { name = "air", force_place = true, prob = 255 }
local t4nst = { name = "air", param2 = 2, force_place = true, prob = 255 }
local t4pst = { name = "air", force_place = true, prob = 255 }
--- general deco
local rbcob = { name = "nc_terrain:cobble", force_place = false, prob = 255 }
local rbtorch = { name = "nc_torch:torch", param2 = 1, force_place = true, prob = 50 }
local rbtorch2 = { name = "nc_torch:torch", param2 = 1, force_place = false, prob = 255 }
local rbtorch3 = { name = "nc_torch:torch", param2 = 1, force_place = true, prob = 255 }
local rbfence = { name = "nc_flora:wicker", force_place = false, prob = 255 }
local rbfence2 = { name = "nc_concrete:terrain_stone_verty", force_place = false, prob = 255 }
local rbfence3 = { name = "nc_woodwork:frame", force_place = true, prob = 255 }
--- placeholder. chest is placed directly on map
local rbchest = { name = "nc_woodwork:shelf", force_place = true, prob = 255, param2 = 1 }
--- water deco
local rbwt1 = { name = "nc_flora:thatch", param2 = 9, force_place = true, prob = 255 }
	...
	for z = minp.z, maxp.z do
		...
		if ( ((y - hmap[hm_i]) > -8) or (excessive_clearing == 1) ) then
			...
			{"group:tree", "group:leaves", "group:leafdecay", "group:leafdecay_drop", "group:plant", "group:flora", 
			 "group:sapling", "default:snow", "default:flora", "default:cactus"})
		...
		if ( minetest.get_node({x = x, y = y, z = z}).name == "nc_terrain:water_source" ) then
